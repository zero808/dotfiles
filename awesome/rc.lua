...
tags = {
  names  = { "term", "code", "web", "media", "else" },
  layout = { layouts[2], layouts[1], layouts[4], layouts[1], layouts[1],
...
clockicon:set_image("/home/duarte/.config/awesome/icons/clock.png")
...
-- volicon:set_image("/home/duarte/.config/awesome/icons/vol.png")
-- volwidget = wibox.widget.textbox()
-- vicious.register(volwidget, vicious.widgets.volume, " $1% ", 2, "Master")

-- Wifi Widget
wifiwidget = wibox.widget.textbox()
vicious.register(wifiwidget, vicious.widgets.wifi, "<span color='#cccccc'>~</span> ${link}%", 5, "wlp2s0")

-- Create a battery widget
baticon = wibox.widget.imagebox()
baticon:set_image("/home/duarte/.config/awesome/icons/bat.png")
-- Initialize widget
